							...
							<ul class="navbar-nav">
								<li class="nav-item dropdown"><a
									...
									<div class="dropdown-menu"
										...
										<a class="dropdown-item" href="dashboardUser">Dashboard</a> <a
	...
	<div
		...
		<div class="card bg-dark text-white">
			...
			<div class="card-img-overlay">
				...
				<p class="card-text">
				<h3>Book Your Ride and Enjoy your Luxurious Time</h3>
				</p>
				<br /> <br /> <br /> <br /> <br /> <br /> <a href="loadBookRide"
					class="btn btn-primary button">Book Now!!!</a>
			</div>
		</div>
	</div>
	...
	<div
		...
		<div class="card bg-dark text-white">
			...
			<div class="card-img-overlay">
				...
				<p class="card-text">
				<h3>Watch Your Previous Bookings, Current Bookings,Booking
					Status,etc</h3>
				</p>
				<br /> <br /> <br /> <br /> <br /> <br /> <a href="userAllBookingRides"
