		...
		<div class="table-responsive">
			<div class="table-wrapper">
				...
				<table class="table table-striped table-hover table-bordered">
					...
					<c:forEach var="i" items="${driverDataWithStatus}" varStatus="j">
						<tbody>
							<tr>
								<td>${j.count}</td>
								...
								<td>${i.status}</td>
								<td><div style="float:left"><a href="acceptRide?bookId=${i.rideId}"
									class="delete" title="Delete" data-toggle="tooltip"><button
											type="button" class="btn btn-outline-primary">&#10003;</button></a></div>
									<div style="float:left"><a href="rejectRide?bookId=${i.rideId}" class="delete"
									title="Delete" data-toggle="tooltip"><button type="button"
											class="btn btn-outline-primary">&#10005;</button></a></div>
							</tr>
					</c:forEach>
					</tbody>
				</table>
